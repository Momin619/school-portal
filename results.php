...
<body>
    ...
    <div class="container">
        <!-- Tabs -->
        <div class="tabs">
            <div class="tab active" data-target="#add-student">Add Result</div>
            <div class="tab" data-target="#view-students">View Result</div>
            <div class="tab" data-target="#update-student">Update Result</div>
            <div class="tab" data-target="#delete-student">Delete Result</div>
        </div>
